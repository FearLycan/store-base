...
Seo::apply($this, 'Saved', 'Your saved products.', Url::to(['/catalog/saved'], true), true);
?>
<h1 class="mb-5 text-2xl font-bold">Saved</h1>
<div x-data x-cloak>
    <div x-show="$store.shop.favs.length === 0" class="rounded-xl border border-dashed border-gray-200 bg-white p-10 text-center">
        ...
        <p class="font-medium text-gray-700">Nothing saved yet</p>
        <p class="mt-1 text-sm text-gray-500">Tap the heart on any product to keep it here.</p>
    </div>
